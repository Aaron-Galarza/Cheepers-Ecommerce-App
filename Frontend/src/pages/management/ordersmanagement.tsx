...
// [MODIFICADO] guestEmail eliminado de la interfaz
...
  // [MODIFICADO] guestEmail eliminado del estado inicial
...
      return;
    }
    // [ELIMINADO] Validación de guestEmail
...
    const orderData: Omit<NewOrderData, 'guestEmail'> = {
