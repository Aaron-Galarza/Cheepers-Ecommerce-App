...
const bannerItems = [
   {image: pizzalibre,   title: 'PIZZA LIBRE', descriptionLine1: 'Pizza libre ', descriptionLine2: 'Miercoles y Jueves.', callToAction: '¡No te lo pierdas!', altText: 'pizza', targetRoute: '/menu' },
