...
const bannerItems = [
  { image: sandwichVacio,  title: 'BURGUER PAN ARABE',  descriptionLine1: 'Sabrosa hamburguesa en pan arabe de 18cm', callToAction: '¡Probalo ahora!', altText: 'Lomito', targetRoute: '/menu' },
