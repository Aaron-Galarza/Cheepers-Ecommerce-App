...
export interface Promotion {
  ...
  imageUrl: string;
  category: string;
  // AÑADIDO: 'tags' en la interfaz para que el frontend lo reconozca
  tags?: string[];
  isActive: boolean;
}
...
  // REVERTIDO A LA LÓGICA ORIGINAL: Cargar todos y filtrar localmente
...
      });
      // FILTRADO LOCALMENTE: Esto es lo que mantiene la funcionalidad original
...
  // Las funciones de creación, actualización y eliminación NO necesitan cambios
  // porque ya aceptan el objeto de datos completo 'data' que incluye los tags.
